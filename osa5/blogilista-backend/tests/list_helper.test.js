...
describe('Total likes', () => {
	test('Many good blogs equals 36 likes', () => {
...
describe('Most liked blog', () => {
	test('Canonical string reduction by Edsger W. Dijkstra', () => {
...
describe('Author with most blogs', () => {
	test('Robert C. Martin with 3 blogs', () => {
...
describe('Most liked author', () => {
	test('Edsger W. Dijkstra with 17 likes', () => {
